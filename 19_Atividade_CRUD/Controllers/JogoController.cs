...
namespace CRUD_MVC.Controllers
{
    public class JogoController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("JogoId,Nome,Imagem,Valor,Ativo")] Jogo jogo)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("JogoId,Nome,Imagem,Valor,Ativo")] Jogo jogo)
        {
            if (id != jogo.JogoId)
            {
                return NotFound();
